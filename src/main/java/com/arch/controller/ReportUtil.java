...
public class ReportUtil implements Serializable {
	...
	public byte[] generateReport(List<Stakeholder> listData, String report, ServletContext servletContext)
			throws Exception {
		...
		String caminhoJasper = servletContext.getRealPath("reports") + File.separator + report + ".jasper";

		/* Carrega o arquivo Jasper passando os dados */
		JasperPrint printJasper = JasperFillManager.fillReport(caminhoJasper, new HashMap<String, Object>(), jrbcds);
